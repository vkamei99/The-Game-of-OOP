...
class ConfigJogo:
    ...
    [1,2,2,2,2,2,2,2,2,3,3,3,2,2,2,2,2,0,0,0,0,0,0,0,2,2,2,2,2,2,2,2,2,2,1],
    [1,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,0,0,0,0,0,0,0,2,2,2,2,2,2,2,2,2,2,1],
    ...
    #TILEMAP = [[random.choice(values) for c in range(35)] for l in range(23)]
